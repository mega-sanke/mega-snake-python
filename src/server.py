...
power_user = globals.User('power-user', None, 0,0)
power_user.add_permission('power')
commander.execute_command(power_user,'add-room', 'test', '1234')
power_user.clear_room()
print globals.rooms
