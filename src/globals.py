...
class User:
    ...
    def has_permission(self, p):
        """
        The function checks if the user has the given permission.
        :param p: The permission that we want to check.
        :type p: str
        :return: True is the user has this permissions, False otherwise.
        :rtype: bool
        """
    ...
    def __str__(self):
        """
        The function returns a representation of the user as a string.
        :return: representation of the user as a string.
        :rtype: str
        """
